...
/**
 * This describes the relation underlying a MatchSet.  There should be some predefined MatchTypes,
 * but also the ability to import from, for example, BGEE's homology ontology
 * @author peter
 * created Oct 8, 2009
 *
 */
