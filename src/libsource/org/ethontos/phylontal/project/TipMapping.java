...
public class TipMapping {
   ...
   LinkedHashMap<ExternalNode,OntologyWrapper> mapper = new LinkedHashMap<ExternalNode,OntologyWrapper>();
   
   public void addPair(ExternalNode n, OntologyWrapper w){
       mapper.put(n,w);
   }
   
   public Set<Map.Entry<ExternalNode, OntologyWrapper>> getPairings(){
